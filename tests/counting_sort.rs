use rand::prelude::*;
use sorted::CountingSort;

#[test]
fn test_counting_sort_vec() {
    let mut v = vec![6, 5, 3, 1, 8, 7, 2, 4, -7, -10, 0, 6, 1];
    v.counting_sort(-10, 8);
